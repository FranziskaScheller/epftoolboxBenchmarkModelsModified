...
df_train, df_test = read_data(dataset='DE', path=path_datasets_folder,
                              begin_test_date=begin_test_date, end_test_date=end_test_date)

# Defining unique name to save the forecast
forecast_file_name = 'fc_nl' + '_dat' + 'DE' + '_YT' + str(years_test) + \
...
for date in forecast_dates:
    ...
    forecast.to_csv('forecasts_lear_' + str(calibration_window) + 'test1107.csv')
